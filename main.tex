...
%-----------------------------------------------
\title{ÉTICA NO USO DA IA NAS UNIVERSIDADES}
...
\addstudent[First Full Name]{LARISSA MARTINS CORDEIRO}
...
\subsection{Políticas institucionais para IA generativa no ensino superior}

\\citet{jin2025generative} analisaram políticas e diretrizes institucionais relacionadas à adoção de inteligência artificial generativa (IA generativa) no ensino superior, considerando 40 universidades distribuídas por seis regiões globais. O estudo, fundamentado na Teoria da Difusão de Inovações, investigou características da adoção da tecnologia, canais de comunicação e papéis e responsabilidades dos diferentes atores institucionais. Os resultados indicaram que as universidades abordadas procuram conciliar a adoção da IA generativa com a integridade acadêmica, a melhoria do ensino e da aprendizagem e o desenvolvimento da alfabetização em IA. Também foram identificadas preocupações relacionadas à privacidade e segurança de dados, à transparência, à avaliação crítica dos conteúdos gerados por IA e à equidade de acesso. Entre as medidas descritas estão a elaboração de diretrizes para o uso ético da IA, adaptações em práticas de avaliação, capacitação de docentes e estudantes, criação de canais de comunicação e definição de responsabilidades para professores, estudantes e administradores. O estudo também identificou lacunas na abrangência das políticas, na comunicação institucional e na avaliação contínua dos impactos da IA generativa. Os autores destacam que a integração da tecnologia exige acompanhamento contínuo e participação dos diferentes atores da comunidade acadêmica, além de políticas que possam ser adaptadas à evolução das ferramentas e dos contextos educacionais.
